...
public class I18nColorsConfig extends OkaeriConfig {
    ...
    private List<I18nColorMatcher> matchers = Arrays.asList(
        I18nColorMatcher.of("^.*(fail|rejected|not.?found|limit.?reached|already|cannot|invalid|error|alert|warning).*$", ChatColor.RED, ChatColor.DARK_RED, "&8[&4&l✘&8] "),
        I18nColorMatcher.of("^.*(success|succeeded|accepted|created|removed|added|done|ended).*$", ChatColor.GREEN, ChatColor.DARK_GREEN, "&8[&2&l✔&8] "),
        I18nColorMatcher.of("^.*$", ChatColor.GRAY, ChatColor.WHITE, "&8[&f&l•&8] ")
    );
}
