package me.drownek.platform.core.persistence;
...
public class PostgresPersistence extends NativeRawPersistence {
    ...
    private static final FilterRenderer FILTER_RENDERER = new PostgresFilterRenderer(new SqlStringRenderer());
    ...
    public void registerCollection(@NonNull PersistenceCollection collection) {
        ...
        try (Connection connection = this.getDataSource().getConnection()) {
            ...
            try {
                ...
                LOGGER.fine("Could not alter key column length for table " + collectionTable +
